...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Headline, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 11
        }
      }, "Buttermilk", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Version, {
        href: "https://github.com/probablyup/buttermilk/releases",
        target: "_blank",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 13
        }
      }, "1.1.0".slice(0, "1.1.0".lastIndexOf('.'))))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Content, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 19
        }
...
var desktop = '@media all and (min-width: 768px)';
var Container = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].div.withConfig({
  displayName: "App__Container"
})(["background:#FAFAFA;min-height:100%;"]);
var Header = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].header.withConfig({
  displayName: "App__Header"
})(["align-items:center;background:white;display:flex;flex-direction:column;justify-content:center;min-height:125px;", "{min-height:300px;}"], desktop);
var Headline = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].h1.withConfig({
  displayName: "App__Headline"
})(["font-family:'Vibur',sans-serif;font-size:5rem;margin:0;position:relative;transform:rotate(-6deg);transform-origin:center;", "{font-size:10rem;text-shadow:0 0 300px white;transition:500ms text-shadow;&:hover{text-shadow:0 0 300px;}}"], desktop);
var Version = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].a.withConfig({
  displayName: "App__Version"
})(["font-size:0.25em;position:absolute;right:-1em;bottom:-0.5em;text-decoration:none;"]);
var Content = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].main.withConfig({
...
var _default = function _default() {
  ...
  }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Home__["a" /* default */], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polished__ = __webpack_require__("./node_modules/polished/dist/polished.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_markdown_to_jsx__ = __webpack_require__("./node_modules/markdown-to-jsx/index.esm.js");
...
var _readme$split = __WEBPACK_IMPORTED_MODULE_4_raw_loader_README_md___default.a.split(/<!-- \/?TOC -->/),
    _readme$split2 = _slicedToArray(_readme$split, 3),

/* h1 tag, badges */
navigation = _readme$split2[1],
    content = _readme$split2[2];
...
function (_React$PureComponent) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      }, __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Navigation, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 13
        }
      }, __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_markdown_to_jsx__["a" /* default */], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 14
        }
      }, navigation.trim().replace(/.*?\n/, '').replace(/^ {4}/gm, '')), __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(GithubLink, {
      ...
      }, GithubIcon), __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Button, {
      ...
      }, "back to top \u219F")), __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Content, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 30
        }
...
var desktop = '@media all and (min-width: 768px)';
var mobile = '@media all and (max-width: 767px)';
var Wrapper = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].div.withConfig({
  displayName: "Home__Wrapper"
})(["display:flex;flex-direction:column;padding:1.5rem 5vw;", "{flex-direction:row;padding-top:3rem;padding-bottom:3rem;}"], desktop);
var Navigation = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].nav.withConfig({
  displayName: "Home__Navigation"
})(["display:block;margin-bottom:3rem;position:sticky;top:10px;white-space:nowrap;z-index:1;", "{&::before{background:", ";border-bottom:1px solid #DDD;content:'';position:absolute;left:-5vw;right:-5vw;top:-10px;bottom:-10px;z-index:-1;}ul{display:inline-block;margin:0;padding:0;ul{display:none;}li{display:inline-block;margin:0 1.5rem 0 0;}}}", "{align-self:flex-start;margin-bottom:0;margin-right:5vw;width:20vw;min-width:300px;white-space:normal;code{word-break:break-all;white-space:normal;}ul{margin:0;padding:0;ul{margin:0 0 1rem 1.5rem;li{margin:0.5rem 0;list-style:lower-roman;}}li{list-style:upper-roman;}}}"], mobile, Object(__WEBPACK_IMPORTED_MODULE_0_polished__["b" /* rgba */])('#FAFAFA', 0.9), desktop);
var GithubLink = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].a.withConfig({
  displayName: "Home__GithubLink"
})(["margin-right:1em;"]);
var GithubIconBase = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].svg.withConfig({
  displayName: "Home__GithubIconBase"
})(["display:inline-block;height:1em;width:1em;vertical-align:middle;"]);
var GithubIcon = __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(GithubIconBase, {
  role: "img",
  title: "GitHub icon",
  viewBox: "0 0 24 24",
...
var Content = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].div.withConfig({
  displayName: "Home__Content"
})(["overflow-x:hidden;"]);
var Button = __WEBPACK_IMPORTED_MODULE_3_styled_components__["b" /* default */].button.withConfig({
  displayName: "Home__Button"
})(["display:none;", "{background:none;border:none;cursor:pointer;display:inline-block;font:inherit;line-height:1;margin:2rem 0 0;padding:0;opacity:0.5;transition:300ms opacity ease;&:hover,&:focus{opacity:1;}}"], desktop);
;
...
/***/ "./node_modules/markdown-to-jsx/index.esm.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_unquote__ = __webpack_require__("./node_modules/unquote/index.js");
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polished__ = __webpack_require__("./node_modules/polished/dist/polished.es.js");
...
var red = '#8a0000';
Object(__WEBPACK_IMPORTED_MODULE_3_styled_components__["c" /* injectGlobal */])(_templateObject, red, red, Object(__WEBPACK_IMPORTED_MODULE_0_polished__["a" /* darken */])(0.2, red), Object(__WEBPACK_IMPORTED_MODULE_0_polished__["b" /* rgba */])(red, 0.25), Object(__WEBPACK_IMPORTED_MODULE_0_polished__["b" /* rgba */])(red, 0.05), Object(__WEBPACK_IMPORTED_MODULE_0_polished__["b" /* rgba */])(red, 0.05));

var _default = function _default() {
  return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_App__["a" /* default */], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 129
    }
